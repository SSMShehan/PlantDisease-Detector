                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: isSelected ? AppColors.textPrimary : const Color(0xFF9AA5B4),
                      ),
                    ),
                  ),
                ),
    ...
    return ListView(
      ...
      children: [
        _buildSavedCard(
          ...
          iconGradient: const LinearGradient(colors: [Color(0xFFE07A5F), Color(0xFFC96A4F)]),
          date: 'Added 2d ago',
        ),
        _buildSavedCard(
          ...
          iconGradient: const LinearGradient(colors: [Color(0xFF81B29A), Color(0xFF5A9E7C)]),
          date: 'Added 1w ago',
        ),
        _buildSavedCard(
          ...
          iconGradient: const LinearGradient(colors: [Color(0xFFF5A623), Color(0xFFD38B1B)]),
          date: 'Added 2w ago',
        ),
      ],
    );
    ...
    return ListView(
      ...
      children: [
        ...
        _buildSavedCard(
          ...
          iconGradient: const LinearGradient(colors: [Color(0xFF4A90E2), Color(0xFF357ABD)]),
          date: 'Added 5d ago',
        ),
      ],
    );
